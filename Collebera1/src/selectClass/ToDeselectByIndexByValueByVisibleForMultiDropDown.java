...
public class ToDeselectByIndexByValueByVisibleForMultiDropDown {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		fruitListDrop.deselectByIndex(5);
		Thread.sleep(2000);
		fruitListDrop.deselectByValue("1");
		Thread.sleep(2000);
		fruitListDrop.deselectByVisibleText("Guava");
